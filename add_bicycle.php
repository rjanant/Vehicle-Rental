				...
				<div class="box">
					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form">
								<p>
									...
									<input type="text" class="field size1" name="bicycle_name" required />
								</p>	
								<p>
									<span class="req">max 20 symbols</span>
									<label>Vehicle Make <span>(Required Field)</span></label>
									<input type="text" class="field size1" name="bicycle_type" required />
								</p>
								<p>
									<span class="req">max 20 symbols</span>
					...
					<?php
							if(isset($_POST['send'])){
								...
								$qr = "INSERT INTO bicycle (image, bicycle_name,bicycle_type,hire_cost,capacity,status) 
													VALUES ('$image','$bicycle_name','$bicycle_type','$hire_cost','$capacity','Available')";
								$res = $conn->query($qr);
								if($res === TRUE){
