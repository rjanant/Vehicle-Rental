			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						<a href="add_cars.php" class="add-button"><span>Add new Car</span></a><br>
						<div class="cl">&nbsp;
<a href="add_bicycle.php" class="add-button"><span>Add new Bicycle</span></a><br>
						<div class="cl">&nbsp;
<a href="add_bike.php" class="add-button"><span>Add new bike</span></a><br>
						<div class="cl">&nbsp;
<a href="add_traveller.php" class="add-button"><span>Add new Traveller Van</span></a><br>
