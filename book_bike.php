	...
	<section class="listings">
		<div class="wrapper">
			...
			<?php
						...
						$sel = "SELECT * FROM bike WHERE bike_id = '$_GET[id]'";
						$rs = $conn->query($sel);
						$rws = $rs->fetch_assoc();
			?>
				<li>
					...
					<div class="property_details">
						<h1>
							<a href="book_bike.php?id=<?php echo $rws['bike_id'] ?>"><?php echo 'Car Make>'.$rws['bike_type'];?></a>
						</h1>
						<h2>Car Name/Model: <span class="property_size"><?php echo $rws['bike_name'];?></span></h2>
					</div>
				</li>
